...
let favoriteThings = {
  ...
  food:"veggie",
  person: "xavier",
  book:"the complete penny stock",
  movie:"note book",
  holiday:"the note book",
}
...
//Code Here
let myFirstVehicle = new Vehicle(5, 'marron', 114000)
myFirstVehicle.move(15000)
...
class Motorcycle extends Vehicle{
  constructor(capacity, color, mileage, isCool){
...
//Code Here 
let myFirstMotorcycle= new Motorcycle(2, 'blue' 1000, 'yamaha' true)

/*
  Call the move function on myFirstMotorcycle (don't forget the parameter)
*/myFirstMotorcycle.move(400)
...
//Code Here
const myFirstBoat = new Boat(5, 'blue', 1000, false)
